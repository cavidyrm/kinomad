...
(() => {
  ...
  const stylesheet =
    ...
    // touch-action stays open so a finger starting on the image can still pan the
    // page (and any horizontal carousel the slot sits in). Only reframe mode, which
    // drags the image itself, needs the gestures suppressed.
